  ...
  .get("/", clerkMiddleware(), async (c) => {
    ...
    const data = await db
      .select({
        ...
        coDescription1: companiesAI.coDescription1,
        coDescription2: companiesAI.coDescription2,
        coDescription3: companiesAI.coDescription3,
        coTargetCustomerProfile: companiesAI.coTargetCustomerProfile,
        coCustomerProblem1: companiesAI.coCustomerProblem1,
        coCustomerProblem2: companiesAI.coCustomerProblem2,
        coCustomerProblem3: companiesAI.coCustomerProblem3,
        coMarketSize: companiesAI.coMarketSize,
        coMarketLandscape: companiesAI.coMarketLandscape,
        coProduct1: companiesAI.coProduct1,
        coProduct2: companiesAI.coProduct2,
        coProduct3: companiesAI.coProduct3,
        coDifferentiation1: companiesAI.coDifferentiation1,
        coDifferentiation2: companiesAI.coDifferentiation2,
        coDifferentiation3: companiesAI.coDifferentiation3,
        coAdditionalNotes: companiesAI.coAdditionalNotes,
        coSummary: companiesAI.coSummary,
        coExecutiveSummary: companiesAI.coExecutiveSummary,
      })
      .from(companiesAI)
      ...
      try {
        ...
        const [data] = await db
          ...
          .values({
            ...
            coDifferentiation1: parsedSummary.coDifferentiation1 || "",
            coDifferentiation2: parsedSummary.coDifferentiation2 || "",
            coDifferentiation3: parsedSummary.coDifferentiation3 || "",
            coAdditionalNotes: parsedSummary.coAdditionalNotes || "",
            coExecutiveSummary: parsedSummary.coExecutiveSummary || "",
            coSummary: summary,
          })
          .returning();
