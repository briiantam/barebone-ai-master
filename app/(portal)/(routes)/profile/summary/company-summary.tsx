      ...
      <Dialog open={isEditing} onOpenChange={setIsEditing}>
        <DialogTrigger asChild>
          <button
            ...
            className="shadow-[0_0_0_3px_#000000_inset] flex mb-4 px-6 py-2 bg-black border border-white text-white rounded-lg font-bold transform hover:-translate-y-1 transition duration-400 hover:bg-neutral-700"
          >
